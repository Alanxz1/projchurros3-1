...
<body>
    ...
    <main class="body-home">
        <div id="container" class="container-home">
            ...
            <div class="portada">
                <img class="imagem-topo" src="../imagens/backgroundchurros.jpg" alt="churros" width=100% height="350px">
            </div>
           ...
           <section class="minimenu">
                <div class="itens-menu">
                    <div>
                        ...
                        <div class="info1">
                            <h3>CHURROS DA FELICIDADE</h3> <br>
                ...
                <div class="itens-menu">
                    <div>
                        ...
                        <div class="info3">
                            <h3>CHURRO TRADICIONAL DOCE DE LEITE</h3> <br>
